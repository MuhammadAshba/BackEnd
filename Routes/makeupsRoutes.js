...
const {getIn}=require('../Controller/makeupsController')
...
router.post('/makeupdata', upload.fields([{ name: 'coverPicture', maxCount: 1 }, { name: 'pictureOfVenue', maxCount: 1 }]), async (req, res) => {
    ...
    try {
        await Makeups.create(distilled_obj);
