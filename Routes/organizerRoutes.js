...
// get Route
router.route('/get/all').get(getIn)
...
router.post('/post/data', upload.fields([{ name: 'coverPicture', maxCount: 1 }, { name: 'pictureOfVenue', maxCount: 1 }]), async (req, res) => {
    ...
    try {
        await Organizer.create(distilled_obj);
